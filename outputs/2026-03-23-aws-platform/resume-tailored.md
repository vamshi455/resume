...
- Lead Data Engineer and AI Solutions Architect with 20+ years of
  ...
  production-grade AI/ML solutions on AWS and Azure. Delivered governed
  data platforms for energy majors including Exxon Mobil, Marathon
  Petroleum, Shell, and Phillips 66 — leveraging AWS services (S3, Glue,
  Lambda, Redshift, Step Functions, CloudWatch, IAM) and Snowflake on AWS
  for large-scale data engineering, analytics, and AI workloads. Partnered
  with product, data, and platform teams to modernize data platforms,
...
- Cloud Platforms & Data Processing: AWS (S3, Glue, Lambda, Redshift,
  Step Functions, CloudWatch, EMR, IAM), Snowflake, Databricks, Apache
  Airflow (MWAA), dbt (Data Build Tools), Fivetran, Delta Lake, Azure
...
- Foundry & AIP Builder Foundations (Palantir Technologies), Building
  Generative AI Applications Using Amazon Bedrock, Agentic AI
